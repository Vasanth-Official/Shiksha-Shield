      ...
      <div class="card overflow-hidden">
        ...
        <div class="overflow-x-auto">
          <table class="data-table">
            ...
            <tbody>
              ${students.length === 0 ?
        '<tr><td colspan="8" class="py-20 text-center text-slate-400">No students found for this school.</td></tr>' :
        students.map(s => `<tr>
...
async function renderInterventions(content, user) {
  content.innerHTML = '<div class="flex items-center justify-center py-20"><div class="w-8 h-8 border-3 border-saffron border-t-transparent rounded-full animate-spin"></div></div>';
  try {
    const interventions = await api(`/interventions?school_id=${user.school_id || 1}`);
    ...
    content.innerHTML = `
      ...
      <div class="card overflow-hidden">
        ...
        '<tr><td colspan="7" class="py-20 text-center text-slate-400">No interventions recorded for this school.</td></tr>' :
